    ...
    <main id='page-4' className=''>
      <section className="bg-[#141414] bg-[linear-gradient(95.93deg,#262626_-26.82%,rgba(38,38,38,0)_40.46%)] border-b border-b-[#262626] pr-32 pl-16 py-24">
        ...
        <section className='w-full grid grid-cols-4 gap-2.5 p-2.5 bg-[#141414] border border-[#262626] shadow-[0_0_0_6px_rgba(25,25,25,1)]'>
          ...
          <section className="w-full grid bg-[rgb(20,20,20)] gap-10 px-16 py-10">
  ...
  <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
    ...
    >
      Send your Message
        ...
        <div className='w-full grid gap-6'>
          ...
          <div className='w-full grid gap-5 grid-cols-2'>
              {locations
                ...
                .map((loc) => (
                  <div key={loc.id} className='w-full grid gap-7.5 p-7.5 border border-[rgba(38,38,38,1)] bg-[rgba(20,20,20,1)] rounded-lg'>
                    <aside className='w-full grid gap-2'>
                      ...
                      <p className='text-[rgba(153,153,153,1)] font-medium text-[16px] leading-[150%] tracking-[-0.006em]'>{loc.description}</p>
                    </aside>
        ...
        <section className='w-full py-10 px-16 bg-[rgb(20,20,20)]'>
          <div 
            className='w-full grid gap-5 p-10 bg-[rgba(26,26,26,1)] border border-[rgba(38,38,38,1)] rounded-xl'
            style={{
            ...
            <div className='w-full grid grid-cols-2 gap-5'>
              ...
              <div className="w-full grid gap-1 overflow-hidden h-fit">
                  {/* Header */}
                  <StarIcon />
                        <h1 className="font-semibold text-[38px] leading-[150%] tracking-[0] text-white p">
                        Explore Estatein's World
                        </h1>
                        <p className="text-[#999999] font-medium text-[16px] leading-[150%] tracking-[0]">
