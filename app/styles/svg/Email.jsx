...
export default function Email() {
    return (
        <svg className='email-icon' viewBox="0 0 83 82" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M26.625 36.2812V48.4375C26.625 50.7847 28.5278 52.6875 30.875 52.6875H52.125C54.4722 52.6875 56.375 50.7847 56.375 48.4375V36.2812L43.7274 44.0644C42.3614 44.905 40.6386 44.905 39.2726 44.0644L26.625 36.2812Z" fill="#A685FA" />
            <path d="M56.375 33.7861V33.5625C56.375 31.2153 54.4722 29.3125 52.125 29.3125H30.875C28.5278 29.3125 26.625 31.2153 26.625 33.5625V33.7861L40.3863 42.2546C41.0693 42.6749 41.9307 42.6749 42.6137 42.2546L56.375 33.7861Z" fill="#A685FA" />
            <defs>
