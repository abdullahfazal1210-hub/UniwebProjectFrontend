...
export default function CaptureIcon() {
  return (
    <svg className='capture-icon' viewBox="0 0 82 82" fill="none" xmlns="http://www.w3.org/2000/svg">
