...
export default function Socials() {
    return (
        <svg className='social-icon' viewBox="0 0 83 82" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M41.5 55C33.7689 55 27.5 48.7311 27.5 41H41.5V55Z" fill="#A685FA" />
            <path d="M27.5 27C35.2311 27 41.5 33.2689 41.5 41H27.5V27Z" fill="#A685FA" />
            <path d="M41.5 55C49.2311 55 55.5 48.7311 55.5 41H41.5V55Z" fill="#A685FA" />
