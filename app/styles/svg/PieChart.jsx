...
export default function PieChart() {
    return (
        <svg className='pie-chart-icon' viewBox="10 -10 82 110" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path fillRule="evenodd" clipRule="evenodd" d="M27.1875 43.125C27.1875 36.6702 32.4202 31.4375 38.875 31.4375C39.4618 31.4375 39.9375 31.9132 39.9375 32.5V42.0625H49.5C50.0868 42.0625 50.5625 42.5382 50.5625 43.125C50.5625 49.5798 45.3298 54.8125 38.875 54.8125C32.4202 54.8125 27.1875 49.5798 27.1875 43.125Z" fill="#A685FA" />
            <path fillRule="evenodd" clipRule="evenodd" d="M42.0625 28.25C42.0625 27.6632 42.5382 27.1875 43.125 27.1875C49.5798 27.1875 54.8125 32.4202 54.8125 38.875C54.8125 39.4618 54.3368 39.9375 53.75 39.9375H43.125C42.5382 39.9375 42.0625 39.4618 42.0625 38.875V28.25Z" fill="#A685FA" />
            <defs>
